...
echo "Copie and paste this adresse in your browser 'http://$(hostname -i)/mediawiki'"
...
echo""
echo -e "Installation of wikimedia"
...
echo -e "Copy the file LocalSettings.php in the /var/www/html/mediawiki/"
echo -e "Paste in the file LocalSettings.php that you are created"

echo "Exécute this line: chmod 644 /var/www/html/mediawiki/LocalSetting.php"
